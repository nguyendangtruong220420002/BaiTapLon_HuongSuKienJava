...
public class qlnvFr extends JFrame implements ActionListener{
    ...
    private void displayDataInTable() {
        ...
        for (NhanVien nhanVien : nhanVienList) {
            Object[] rowData = {nhanVien.getMaNV(), nhanVien.getTenNV(),nhanVien.getGioiTinh(),
            		//new java.util.Date(nhanVien.getNgaySinh().getTime()),
            		nhanVien.getNgaySinh(),
            		nhanVien.getSdt(), nhanVien.getDiaChi(), nhanVien.getTaiKhoan(), nhanVien.getMatKhau()};
...
//    }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(tfMaNV, GroupLayout.PREFERRED_SIZE, 127, GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(lbNgaysinh,GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(tfNgaysinh, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            )
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            .addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jLabel2, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 65, GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                    .addComponent(passConfirm, GroupLayout.PREFERRED_SIZE, 125, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(pass, GroupLayout.PREFERRED_SIZE, 125,GroupLayout.PREFERRED_SIZE))
                                .addGap(1, 1, 1))
                            .addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(rbNu, GroupLayout.PREFERRED_SIZE, 54,GroupLayout.PREFERRED_SIZE)
                                        .addGap(8, 8, 8)
                                        .addComponent(rbNam, GroupLayout.PREFERRED_SIZE, 63, GroupLayout.PREFERRED_SIZE))
                                    .addComponent(tfTaikhoan, GroupLayout.PREFERRED_SIZE, 125, GroupLayout.PREFERRED_SIZE))))))
                .addContainerGap()
                )
            .addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(tfHoten, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                            .addComponent(lbGioitinh)
                            .addComponent(rbNu)
                            .addComponent(rbNam))
                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(passConfirm, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,GroupLayout.PREFERRED_SIZE)
                    .addComponent(tfDiachi, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        btnFind.setFont(new Font("Tahoma", 0, 14)); // NOI18N
        btnFind.setIcon(new ImageIcon(getClass().getResource("/Photos/search (1).png"))); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                            .addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(tfFind)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btnFind, GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 600, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            .addComponent(tfFind, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 37,GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnFind, GroupLayout.Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnBackActionPerformed() {
        if (detail != null) { // Kiểm tra xem detail có bằng null không
            ...
            // Xử lý trường hợp detail là null, có thể hiển thị thông báo lỗi hoặc thực hiện hành động khác tùy theo yêu cầu của ứng dụng.
    ...
    private void displaySearchResults(List<NhanVien> searchResults) {
        ...
        for (NhanVien nhanVien : searchResults) {
            Object[] rowData = {nhanVien.getMaNV(), nhanVien.getTenNV(), nhanVien.getGioiTinh(),
                                nhanVien.getNgaySinh(), nhanVien.getSdt(), nhanVien.getDiaChi(),
                                nhanVien.getTaiKhoan(), nhanVien.getMatKhau()};
            tableModel.addRow(rowData);
        }
    }
    ...
    public static void main(String args[]) throws SQLException {
		...
		NhanVienDAO nhanVienDAO = new NhanVienDAO(Connect_DB.getConnection()); // Tạo đối tượng NhanVienDAO với kết nối cơ sở dữ liệu
